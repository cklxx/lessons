...
![图 20-1：治理闭环（边界→审计→红队→门禁→处置→复盘）示意](../../assets/figure_20_1_1766035315450.png)
...
更好的拒答设计像一位有原则的向导：你不会带他去禁区，但你会告诉他**边界在哪里、为什么、以及可行的替代路线**。把拒绝转化为引导，你就能在不触碰红线的前提下维持交互的流动性，让用户仍然能完成任务的核心部分。
