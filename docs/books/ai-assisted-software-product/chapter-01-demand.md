...
![图：需求验证闭环流程图](../../assets/fig-placeholder.svg)

*图 1-1：需求验证闭环流程图：从评论样本采集到商业实验门槛*
<!-- TODO: replace figure with a flowchart for Ch01 -->
...
**步骤：**
1. 从一个或多个公开渠道采集评论，落盘为 `data/reviews.csv`；同时生成一份最小 datasheet（来源/采集时间/许可证/样本量/去重策略）。[34][35]
...
![图：主题 × 满意度热力图示例](../../assets/fig-placeholder.svg)

*图 1-2：主题-满意度关联热力图示例（注：需标注样本量与时间窗口以规避伪相关）*
<!-- TODO: replace figure with a real heatmap screenshot -->
