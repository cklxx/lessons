...
![图：超级个体的能力演进与交付物](../../assets/fig-placeholder.svg)

*图：Caller → Designer → Shaper 三阶段能力叠加，以及每阶段对应的交付物类型（示意）*
<!-- TODO: replace figure with a simple roadmap diagram for the preface -->
