...
> 用法：后续改写任意一章时，先对照本节确认“这一章到底在解决什么、闭环是什么、门禁是什么”，避免写成散点知识。
...
### 第 3 章：生成式 UI/UX 设计
- **第 1 层（目标）**：把“好看”变成可回归的组件交付物，而不是一次性截图。
