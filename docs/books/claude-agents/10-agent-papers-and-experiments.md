...
- **[SWE-bench Goes Live!](papers/swe-bench-goes-live.md)** [96]
  - 年份：2025 [96]
  - 递进关系：前序：[SWE-bench](papers/swe-bench.md)；后续：无（评测治理与线上化方向代表） [96]
...
- **[OSWorld-Human](papers/osworld-human.md)** [97]
  - 年份：2025 [97]
  - 递进关系：前序：[OSWorld](papers/osworld.md)；后续：无（人类效率对照方向代表） [97]
...
- **[Mobile-Agent-v3](papers/mobile-agent-v3.md)** [98]
  - 年份：2025 [98]
...
- **[MobileUse](papers/mobileuse.md)** [100]
  - 年份：2025 [100]
  - 递进关系：前序：[Mobile-Agent-v3](papers/mobile-agent-v3.md)；后续：无（移动端反思策略方向代表） [100]
...
- **[MagicGUI](papers/magicgui.md)** [101]
  - 年份：2025 [101]
  - 递进关系：前序：[Mobile-Agent-v3](papers/mobile-agent-v3.md)；后续：无（移动端基础模型方向代表） [101]
...
- **[UI-Evol](papers/ui-evol.md)** [102]
  - 年份：2025 [102]
  - 递进关系：前序：[OSWorld](papers/osworld.md)；后续：无（计算机使用知识演化方向代表） [102]
...
- **[MCP-Bench](papers/mcp-bench.md)** [99]
  - 年份：2025 [99]
  - 递进关系：前序：[ToolLLM](papers/toollm.md)、[StableToolBench](papers/stable-toolbench.md)；后续：无（MCP 工具评测方向代表） [99]
