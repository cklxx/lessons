...
## 关键数据结果
- HumanEval（Python）上，Reflexion 的 pass@1 为 91.0%，超过 GPT-4 的 80.1%。[72]
- ALFWorld 上，Reflexion 在 12 次迭代内带来 22 个百分点的绝对成功率提升。[72]
- HotpotQA 上，Reflexion 相对基线提升 20 个百分点准确率；HumanEval 任务上提升 11 个百分点。[72]
