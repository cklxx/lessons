...
## 关键数据结果
- LAMA 子集（SQuAD / Google-RE / T-REx）上，Toolformer 为 33.8 / 11.5 / 53.5，显著高于 Toolformer (disabled) 的 22.1 / 6.3 / 34.9。[69]
- 数学推理基准（ASDiv / SVAMP / MAWPS）上，Toolformer 为 40.4 / 29.4 / 44.0，对比 Toolformer (disabled) 的 14.8 / 6.3 / 15.0。[69]
- 事实问答基准（WebQS / NQ / TriviaQA）上，Toolformer 为 26.3 / 17.7 / 48.8，高于 Toolformer (disabled) 的 18.9 / 12.6 / 46.7。[69]
