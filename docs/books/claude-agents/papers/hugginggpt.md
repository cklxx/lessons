...
## 关键数据结果
- 单任务规划评测中，GPT-3.5 的 Accuracy/F1 为 52.62/54.45，显著高于 Vicuna-7b 的 23.86/29.44。[77]
- 序列任务规划中，GPT-3.5 的 ED 为 0.54、F1 为 51.92，优于 Alpaca-7b 的 ED 0.83、F1 22.80。[77]
- 人评结果中，GPT-3.5 的任务规划通过率/合理性为 91.22%/78.47%，模型选择通过率/合理性为 93.89%/84.29%，整体成功率 63.08%。[77]
