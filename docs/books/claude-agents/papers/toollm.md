...
## 关键数据结果
- ToolBench 收集 16,464 个 REST API（来自 49 个类别），由 53,190 个候选 API 过滤得到 3,451 个高质量工具。[83]
- 数据产出规模：约 200k 条 instruction-API 对，以及 126,486 条 instruction-solution path 用于训练 ToolLLaMA。[83]
- ToolEval 与人工评价一致性：pass rate 一致率 87.1%，win rate 一致率 80.3%。[83]
