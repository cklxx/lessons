...
## 关键数据结果
- 在 6 个公共基准的平均结果中，ReWOO 相比 ReAct 将 token 使用量降低 64%，同时带来 4.4 个百分点的绝对准确率提升。[73]
- 在 SOTUQA 文档问答任务上，ReWOO 比 ReAct 提升 8 个百分点准确率，并减少 43% token。[73]
- HotpotQA（ALM 设置）上，ReWOO Acc/F1/EM 为 42.4/40.1/30.4，平均 1,986 tokens；ReAct 为 40.8/39.6/32.2，9,795 tokens。[73]
