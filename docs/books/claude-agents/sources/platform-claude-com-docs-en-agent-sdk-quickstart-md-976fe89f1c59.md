...
<Note>
If you see "Claude Code not found", [install Claude Code] and restart your terminal. For "API key not found", [set your API key]. See the [full troubleshooting guide](https://code.claude.com/docs/en/troubleshooting) for more help.
</Note>
