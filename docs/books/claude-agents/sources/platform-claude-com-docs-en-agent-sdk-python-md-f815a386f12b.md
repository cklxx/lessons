...
- Retrieved: 2026-01-08T05:11:30.798893+00:00
...
| `output_format`               | [`OutputFormat`] ` \| None`   | `None`               | Define output format for agent results. See [Structured outputs](https://platform.claude.com/docs/en/agent-sdk/structured-outputs) for details                                                                    |
