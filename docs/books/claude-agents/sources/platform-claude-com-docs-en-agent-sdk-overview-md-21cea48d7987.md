...
- Retrieved: 2026-01-08T05:11:30.170385+00:00
...
<Tabs>
  ...
  <Tab title="Hooks">
    ...
    **Available hooks:** `PreToolUse`, `PostToolUse`, `Stop`, `SessionStart`, `SessionEnd`, `UserPromptSubmit`, and more.
    ...
    [Learn more about hooks →](https://platform.claude.com/docs/en/agent-sdk/hooks)
  </Tab>
  <Tab title="Subagents">
    ...
    [Learn more about subagents →](https://platform.claude.com/docs/en/agent-sdk/subagents)
  </Tab>
  <Tab title="MCP">
    ...
    [Learn more about MCP →](https://platform.claude.com/docs/en/agent-sdk/mcp)
  </Tab>
  <Tab title="Permissions">
    ...
    <Note>
    For interactive approval prompts and the `AskUserQuestion` tool, see [Handle approvals and user input](https://platform.claude.com/docs/en/agent-sdk/user-input).
    </Note>
    ...
    [Learn more about permissions →](https://platform.claude.com/docs/en/agent-sdk/permissions)
  </Tab>
  <Tab title="Sessions">
    ...
    [Learn more about sessions →](https://platform.claude.com/docs/en/agent-sdk/sessions)
  </Tab>
</Tabs>
