...
- Retrieved: 2026-01-08T05:11:25.079955+00:00
...
<Frame>
  ![Image](https://platform.claude.com/docs/images/tool_choice.png)
</Frame>
...
<Tip>
To eliminate invalid tool calls entirely, use [strict tool use](https://platform.claude.com/docs/en/build-with-claude/structured-outputs) with `strict: true` on your tool definitions. This guarantees that tool inputs will always match your schema exactly, preventing missing parameters and type mismatches.
</Tip>
...
See the [general formatting requirements above] for other formatting rules.
...
- Claude Sonnet 3.7: May need stronger prompting or the `token-efficient-tools-2025-02-19` [beta header](https://platform.claude.com/docs/en/api/beta-headers). Consider [upgrading to Claude 4](https://platform.claude.com/docs/en/about-claude/models/migrating-to-claude-4).
