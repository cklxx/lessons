...
- URL: https://platform.claude.com/docs/en/agent-sdk/typescript.md
- Retrieved: 2026-01-08T05:11:31.087242+00:00
...
| `plugins` | [`SdkPluginConfig`]`` | `` | Load custom plugins from local paths. See [Plugins](https://platform.claude.com/docs/en/agent-sdk/plugins) for details |
