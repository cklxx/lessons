...
## TL;DR
精益创业（The Lean Startup）的核心不是省钱，而是减少浪费——通过**构建-衡量-学习（Build-Measure-Learn）**的反馈循环，用科学实验的方法验证商业假设，在资源耗尽前找到可持续的商业模式。
