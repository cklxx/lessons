...
[Test a site](https://pagespeed.web.dev) [Overview](https://developer.chrome.com/docs/lighthouse/overview)
##  Lighthouse audit categories 
bolt 
###  Performance audits 
Measure performance and find opportunities to speed up page loads. 
[Get started](https://developer.chrome.com/docs/lighthouse/performance/performance-scoring)
accessibility 
###  Accessibility audits 
Determine if all users access content and navigate your site effectively. 
[Get started](https://developer.chrome.com/docs/lighthouse/accessibility/scoring)
star 
###  Best Practices audits 
Improve code health of your web page following these best practices. 
[Get started](https://developer.chrome.com/docs/lighthouse/best-practices/doctype)
search 
###  SEO audits 
Ensure that your page is optimized for search engine results ranking. 
[Get started](https://developer.chrome.com/docs/lighthouse/seo/meta-description)
