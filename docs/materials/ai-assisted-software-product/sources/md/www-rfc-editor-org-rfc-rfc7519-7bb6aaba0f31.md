...
- Retrieved: 2025-12-18T07:34:58.153103+00:00

[[RFC Home](https://www.rfc-editor.org "RFC Editor")] [[TEXT](https://www.rfc-editor.org/rfc/rfc7519.txt)|[PDF](https://www.rfc-editor.org/rfc/pdfrfc/rfc7519.txt.pdf)|[HTML](https://www.rfc-editor.org/rfc/rfc7519.html)] [[Tracker](https://datatracker.ietf.org/doc/rfc7519 "IETF Datatracker information for this document")] [[IPR](https://datatracker.ietf.org/ipr/search/?rfc=7519&submit=rfc "IPR disclosures related to this document")] [[Errata](https://www.rfc-editor.org/errata/rfc7519)] [[Info page](https://www.rfc-editor.org/info/rfc7519 "Info page")]   
  
PROPOSED STANDARD  
Updated by: [7797](https://www.rfc-editor.org/rfc/rfc7797), [8725](https://www.rfc-editor.org/rfc/rfc8725) Errata Exist
...
* * *
    ...
    [2](#section-2).  Terminology
       ...
       Glossary, Version 2" [[RFC4949](./rfc4949 ""Internet Security Glossary, Version 2"")].
...
* * *
    ...
    [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       Collision-Resistant Name
          ...
          (UUIDs) [[RFC4122](./rfc4122 ""A Universally Unique IDentifier \(UUID\) URN Namespace"")].  When using an administratively delegated
       ...
       StringOrURI
          ...
          character MUST be a URI [[RFC3986](./rfc3986 ""Uniform Resource Identifier \(URI\): Generic Syntax"")].  StringOrURI values are
...
* * *
    ...
    [3](#section-3).  JSON Web Token (JWT) Overview
       ...
       As per [Section 4 of RFC 7159](https://www.rfc-editor.org/rfc/rfc7159#section-4) [[RFC7159](./rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")], the JSON object consists of
       ...
       structural characters, in accordance with [Section 2 of RFC 7159](https://www.rfc-editor.org/rfc/rfc7159#section-2)
...
* * *
    ...
    [7.2](#section-7.2).  Validating a JWT
       ...
       4.   Verify that the resulting octet sequence is a UTF-8-encoded
            ...
            [RFC 7159](https://www.rfc-editor.org/rfc/rfc7159) [[RFC7159](./rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")]; let the JOSE Header be this JSON object.
...
* * *
    ...
    [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       10.  Verify that the resulting octet sequence is a UTF-8-encoded
            representation of a completely valid JSON object conforming to
            [RFC 7159](https://www.rfc-editor.org/rfc/rfc7159) [[RFC7159](./rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")]; let the JWT Claims Set be this JSON object.
    ...
    [7.3](#section-7.3).  String Comparison Rules
       ...
       [Section 8.3 of RFC 7159](https://www.rfc-editor.org/rfc/rfc7159#section-8.3) [[RFC7159](./rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")].  Since the only string comparison
...
* * *
    ...
    [10.1.2](#section-10.1.2).  Initial Registry Contents
       ...
       o  Specification Document(s): [Section 4.1.1 of RFC 7519](https://www.rfc-editor.org/rfc/rfc7519#section-4.1.1)
    
       o  Claim Name: "sub"
       o  Claim Description: Subject
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.2 of RFC 7519](https://www.rfc-editor.org/rfc/rfc7519#section-4.1.2)
...
* * *
    ...
    [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.4 of RFC 7519](https://www.rfc-editor.org/rfc/rfc7519#section-4.1.4)
    
       o  Claim Name: "nbf"
       o  Claim Description: Not Before
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.5 of RFC 7519](https://www.rfc-editor.org/rfc/rfc7519#section-4.1.5)
    
       o  Claim Name: "iat"
       o  Claim Description: Issued At
       o  Change Controller: IESG
       o  Specification Document(s): [Section 4.1.6 of RFC 7519](https://www.rfc-editor.org/rfc/rfc7519#section-4.1.6)
    ...
    [10.2.1](#section-10.2.1).  Registry Contents
       ...
       [[RFC6755](./rfc6755 ""An IETF URN Sub-Namespace for OAuth"")], which can be used to indicate that the content is a JWT.
    
       o  URN: urn:ietf:params:oauth:token-type:jwt
       o  Common Name: JSON Web Token (JWT) Token Type
       o  Change Controller: IESG
       o  Specification Document(s): [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)
...
* * *
    ...
    [10.3.1](#section-10.3.1).  Registry Contents
       ...
       o  Security considerations: See the Security Considerations section
          of [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)
       o  Interoperability considerations: n/a
       o  Published specification: [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)
...
* * *
    ...
    [13.1](#section-13.1).  Normative References
       ...
       [JWA]      Jones, M., "JSON Web Algorithms (JWA)", [RFC 7518](https://www.rfc-editor.org/rfc/rfc7518),
                  DOI 10.17487/RFC7518, May 2015,
                  <[http://www.rfc-editor.org/info/rfc7518](https://www.rfc-editor.org/info/rfc7518)>.
    
       [JWE]      Jones, M. and J. Hildebrand, "JSON Web Encryption (JWE)",
                  [RFC 7516](https://www.rfc-editor.org/rfc/rfc7516),  DOI 10.17487/RFC7516, May 2015,
...
* * *
    ...
    [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       [JWS]      Jones, M., Bradley, J., and N. Sakimura, "JSON Web
                  Signature (JWS)", [RFC 7515](https://www.rfc-editor.org/rfc/rfc7515), DOI 10.17487/RFC, May 2015,
                  <[http://www.rfc-editor.org/info/rfc7515](https://www.rfc-editor.org/info/rfc7515)>.
    
       [RFC20]    Cerf, V., "ASCII format for Network Interchange", STD 80,
                  [RFC 20](https://www.rfc-editor.org/rfc/rfc20),  DOI 10.17487/RFC0020, October 1969,
                  <[http://www.rfc-editor.org/info/rfc20](https://www.rfc-editor.org/info/rfc20)>.
    
       [RFC2046]  Freed, N. and N. Borenstein, "Multipurpose Internet Mail
                  Extensions (MIME) Part Two: Media Types", [RFC 2046](https://www.rfc-editor.org/rfc/rfc2046),
       ...
       [RFC3986]  Berners-Lee, T., Fielding, R., and L. Masinter, "Uniform
                  ...
                  [RFC 3986](https://www.rfc-editor.org/rfc/rfc3986), DOI 10.17487/RFC3986, January 2005,
                  <[http://www.rfc-editor.org/info/rfc3986](https://www.rfc-editor.org/info/rfc3986)>.
    
       [RFC4949]  Shirey, R., "Internet Security Glossary, Version 2",
                  FYI 36, [RFC 4949](https://www.rfc-editor.org/rfc/rfc4949), DOI 10.17487/RFC4949, August 2007,
                  <[http://www.rfc-editor.org/info/rfc4949](https://www.rfc-editor.org/info/rfc4949)>.
    
       [RFC7159]  Bray, T., Ed., "The JavaScript Object Notation (JSON) Data
                  Interchange Format", [RFC 7159](https://www.rfc-editor.org/rfc/rfc7159), DOI 10.17487/RFC7159, March
...
* * *
    ...
    [RFC 7519](https://www.rfc-editor.org/rfc/rfc7519)                  JSON Web Token (JWT)                  May 2015
       ...
       [RFC3275]  Eastlake 3rd, D., Reagle, J., and D. Solo, "(Extensible
                  ...
                  [RFC 3275](https://www.rfc-editor.org/rfc/rfc3275), DOI 10.17487/RFC3275, March 2002,
                  <[http://www.rfc-editor.org/info/rfc3275](https://www.rfc-editor.org/info/rfc3275)>.
    
       [RFC3339]  Klyne, G. and C. Newman, "Date and Time on the Internet:
                  Timestamps", [RFC 3339](https://www.rfc-editor.org/rfc/rfc3339), DOI 10.17487/RFC3339, July 2002,
       ...
       [RFC6755]  Campbell, B. and H. Tschofenig, "An IETF URN Sub-Namespace
                  for OAuth", [RFC 6755](https://www.rfc-editor.org/rfc/rfc6755), DOI 10.17487/RFC6755, October 2012,
                  <[http://www.rfc-editor.org/info/rfc6755](https://www.rfc-editor.org/info/rfc6755)>.
    
       [RFC6838]  Freed, N., Klensin, J., and T. Hansen, "Media Type
                  Specifications and Registration Procedures", [BCP 13](https://www.rfc-editor.org/bcp/bcp13),
                  [RFC 6838](https://www.rfc-editor.org/rfc/rfc6838), DOI 10.17487/RFC6838, January 2013,
...
* * *
    ...
    [Appendix B](#appendix-B).  Relationship of JWTs to SAML Assertions
       ...
       using the JSON [[RFC7159](./rfc7159 ""The JavaScript Object Notation \(JSON\) Data Interchange Format"")] object encoding syntax.  It also supports
