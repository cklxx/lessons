...
- Retrieved: 2025-12-18T08:26:27.755725+00:00
- Source: GitHub README (via API)

----

[![Demo of Spectral linting an OpenAPI document from the CLI](https://github.com/stoplightio/spectral/blob/develop/docs/img/readme-header.svg)](https://stoplight.io/api-governance?utm_source=github&utm_medium=spectral&utm_campaign=readme)
...
If you are interested in contributing to Spectral, check out [CONTRIBUTING.md](https://github.com/stoplightio/spectral/blob/develop/CONTRIBUTING.md).
...
Spectral is 100% free and open-source, under [Apache License 2.0](https://github.com/stoplightio/spectral/blob/develop/LICENSE).
