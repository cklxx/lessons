# [2304.12244] WizardLM: Empowering large pre-trained language models to follow complex instructions

- URL: https://arxiv.org/abs/2304.12244
- PDF: https://arxiv.org/pdf/2304.12244.pdf
- Retrieved: 2025-12-17T16:10:33.475270+00:00
...
**arXiv:2304.12244** (cs) 
[Submitted on 24 Apr 2023 ([v1](https://arxiv.org/abs/2304.12244v1)), last revised 27 May 2025 (this version, v3)]
...
Cite as: | [arXiv:2304.12244](https://arxiv.org/abs/2304.12244) [cs.CL]  
  | (or  [arXiv:2304.12244v3](https://arxiv.org/abs/2304.12244v3) [cs.CL] for this version)   
...
### References & Citations
  ...
  * [Google Scholar](https://scholar.google.com/scholar_lookup?arxiv_id=2304.12244)
...
```text
                                         ...
                                         WizardLM: E MPOWERING L ARGE P RE -T RAINED L AN -
                                         GUAGE M ODELS TO F OLLOW C OMPLEX I NSTRUCTIONS

                                          Can Xu1∗ Qingfeng Sun1∗ Kai Zheng1∗ Xiubo Geng1 Pu Zhao1
...
Published as a conference paper at ICLR 2024
                          ...
                          In-Depth Evolving          In-Breadth Evolving   Elimination Evolving
...
3.1   D EFINITION OF I NSTRUCTION DATA E VOLUTION
                                                                                           (0)       (0)              (0)
We start the evolution from a given initial instruction dataset D(0) = (Ik , Rk )1≤k≤N , where Ik
                                              (0)
is the k-th instruction in D(0) , Rk is the corresponding response for the k-th instruction, and N is the
...
for the newly evolved I t+1 . Thus, we obtain an evolved instruction dataset Dt+1 . By iteratively
...
3.2   AUTOMATIC I NSTRUCTION DATA E VOLUTION
...
3.3      F INETUNING THE LLM ON THE E VOLVED I NSTRUCTIONS
...
code (Gao et al., 2021) from OpenLLM.                Figure 3: Automatic evaluations on nine LLM
Code Generation We use the extensively utilized benchmarks.
...
(a) Testset difficulty & complexity level.        (b) Human evaluation results on WizardEval.
...
(a) Average difficulty and complexity level                                                  (b) Average score on automatic benchmarks
...
Edward Beeching, Clémentine Fourrier, Nathan Habib, Sheon Han, Nathan Lambert, Nazneen
...
Vivien A. Cabannes, Léon Bottou, Yann LeCun, and Randall Balestriero. Active self-supervised
...
C   I NCREASED R EASONING S TEPS P ROMPT
...
I   D IFFERENT DIFFICULTY A NNOTATORS
